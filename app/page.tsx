    ...
    <div className="flex justify-center">
      <div className="p-4 font-mono text-black bg-other w-screen">
          <div className="flex justify-center space-x-4 text-sm md:text-base">
            <button onClick={() => scrollToSectionWithOffset(section1Ref, 65)} className="hover:underline hover:decoration-brightred hover:decoration-8 md:decoration-14">Intro</button>
